...
class CourtDocsUploads extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['court_case_id', 'subcat_id', 'court_uploads_id', 'created_at', 'updated_at', 'created_by', 'updated_by'], 'integer'],
    ...
    {
        return $this->hasOne(CourtCaseSubcategory::className(), ['id' => 'subcat_id']);
    }
